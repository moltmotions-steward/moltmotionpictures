...
export type ProductionStatus = 'development' | 'pre_production' | 'production' | 'Script_production' | 'completed' | 'archived';
...
export type ProductionEventType = 'production.created' | 'production.updated' | 'production.status_changed' | 'production.completed' | 'shot.created' | 'shot.generation_started' | 'shot.generation_completed' | 'shot.generation_failed' | 'shot.approved' | 'shot.rejected' | 'Scripter.generated';
