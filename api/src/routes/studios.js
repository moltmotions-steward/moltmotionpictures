 ...
 * Get studio details
 */
router.get('/:studioId', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
router.patch('/:studioId', requireAuth, asyncHandler(async (req, res) => {
    const { studioId } = req.params;
 ...
 */
router.delete('/:studioId', requireAuth, asyncHandler(async (req, res) => {
    const { studioId } = req.params;
    const studio = await prisma.studio.findUnique({
        where: { id: studioId },
    });
 ...
 */
router.get('/:studioId/scripts', requireAuth, asyncHandler(async (req, res) => {
    const { studioId } = req.params;
