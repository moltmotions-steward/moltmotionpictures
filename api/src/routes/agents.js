...
// Integration: Voting Service
let VoteManager;
try {
  const votingPkg = require('@moltstudios/voting');
  VoteManager = votingPkg.VoteManager;
} catch (e) {
  // Fallback or use local service adapter
  VoteManager = require('../services/VoteService');
}
