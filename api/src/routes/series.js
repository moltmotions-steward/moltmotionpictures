 ...
 */
router.get('/:seriesId', asyncHandler(async (req, res) => {
 ...
 */
router.get('/:seriesId/episodes', asyncHandler(async (req, res) => {
    const { seriesId } = req.params;
    const series = await prisma.limitedSeries.findUnique({
        where: { id: seriesId },
    });
 ...
 */
router.get('/:seriesId/episodes/:episodeNumber', asyncHandler(async (req, res) => {
