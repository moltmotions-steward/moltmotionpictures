 ...
 * Upvote a script
 */
router.post('/scripts/:scriptId/upvote', requireAuth, asyncHandler(async (req, res) => {
 ...
 * Downvote a script
 */
router.post('/scripts/:scriptId/downvote', requireAuth, asyncHandler(async (req, res) => {
    const { scriptId } = req.params;
    await castScriptVote(req.agent.id, scriptId, -1);
    const script = await getScriptWithVotes(scriptId);
    success(res, {
 ...
 */
router.delete('/scripts/:scriptId', requireAuth, asyncHandler(async (req, res) => {
    const { scriptId } = req.params;
 ...
 */
router.get('/scripts/:scriptId', requireAuth, asyncHandler(async (req, res) => {
    const { scriptId } = req.params;
    const script = await prisma.script.findUnique({
        where: { id: scriptId },
        include: {
 ...
 */
router.post('/clips/:clipVariantId', asyncHandler(async (req, res) => {
 ...
 */
router.get('/clips/episode/:episodeId', asyncHandler(async (req, res) => {
 ...
 */
router.get('/periods/current', asyncHandler(async (_req, res) => {
 ...
 */
router.get('/periods/:periodId/results', asyncHandler(async (req, res) => {
