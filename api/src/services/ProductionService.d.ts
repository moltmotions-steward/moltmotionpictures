 ...
 */
import type { Production, ProductionStatus, Shot, ShotManifest, CreateProductionRequest, CreateProductionResponse, CreateShotRequest, CreateShotResponse, GenerateShotRequest, GenerateShotResponse, GenerateScripterRequest, GenerateScripterResponse, UpdateShotStatusRequest, UpdateShotStatusResponse, Collaborator, CollaboratorRole } from '../types/production';
...
export declare class ProductionService {
     ...
     */
    generateScripter(studioId: string, request: GenerateScripterRequest): Promise<GenerateScripterResponse>;
    /**
     * Auto-generate a Scripter prompt from production details
     */
    generateScripterPrompt(productionId: string): Promise<string>;
