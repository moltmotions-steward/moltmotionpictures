...
exports.sweepExpiredUnclaimedFunds = sweepExpiredUnclaimedFunds;
const client_1 = require("@prisma/client");
const index_js_1 = __importDefault(require("../config/index.js"));
const prisma = new client_1.PrismaClient();
async function sweepExpiredUnclaimedFunds(limit = 500) {
    const treasuryWallet = index_js_1.default.payouts.treasuryWallet;
    if (!treasuryWallet) {
        return {
            scanned: 0,
            sweptMarked: 0,
...
//# sourceMappingURL=UnclaimedFundProcessor.js.map